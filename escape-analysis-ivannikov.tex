...
%    Presence of these labels in type signatures makes the analysis local
    ...
    Also, our approach incorporates a minimum operation on lifetimes, enabling type signatures to transparently reflect a function's data flow.

    The remainder of this paper is organized as follows.
    Section~\ref{sec:overview} provides informal introduction to our escape analysis approach, illustrated through practical examples.
...
%    Otherwise, this situation can be solved by introducing bivariant projection, but we dedicate this to the future work.
    ...
    Despite that, the minimum of lifetimes can be achieved only indirectly through additional lifetime constraints or by making all corresponding lifetimes equal.
