...
%    Presence of these labels in type signatures makes the analysis local
    ...
    Also, our approach incorporates union types, enabling type signatures to transparently reflect a function's data flow.
    ...
    \[
        \begin{array}{lll}
            ...
            lt_{\Gamma}(\forall \overline{l}~\overline{(\alpha <: \tau)}\ldotp\sigma) & = & lt_{\overline{(\alpha <: Any\ap free)}, \Gamma}(\sigma) \text{ deep remove } \overline{l}
        \end{array}
    \]
