...
%                \text{Eliminate lifetimes} & & elim^p_{\Delta, \overline{l}}(\cdot) \\
    ...
    \[
        \begin{array}{lll}
            ...
            lt_\Gamma^-(\alpha)                                       & = & \emptyset \\ % todo negative case
    ...
    Also, since type constructor parameters are invariant, overapproximating, they are treated as both positive and negative simultaneously. % todo example
