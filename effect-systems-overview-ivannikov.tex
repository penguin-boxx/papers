...
\usepackage{hyperref} % todo comment gives error code on \url
\usepackage{proof}
\newcommand{\seq}{;~}
\newcommand{\ap}{~}
...
% https://tex.stackexchange.com/questions/30228/custom-first-page-with-fancyhdr
\fancypagestyle{firststyle}
{
   \fancyhf{}
   \fancyfoot[L]{\color{gray} 979-8-3315-2602-3/24/\$31.00 \copyright 2024 IEEE}
...
%    Safety implies that the type system should never forget effects: if a function may perform some effect, it should be mentioned in the function's type.
    ...
    Later, a standalone modal effect system was proposed, making novel constructs first-class rather than ad-hoc~\cite{tang2025modal}.
