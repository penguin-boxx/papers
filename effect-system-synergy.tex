...
Namely, the (handle) rule generates a fresh marker and creates a capability as a product of a marker and handler's operations. % todo citations
...
\begin{figure}
    \[
        \begin{array}{llll}
            ...
            \\
            &&&\text{where } t_i : \forall \overline{\alpha}\ldotp \tau'\to (\sigma \to \sigma')\to\sigma',
            \\
            &&& k = \lambda x : [\overline{\alpha\to\tau}]\ap\sigma \ldotp handler_m~h~in~E[x]
            \\
