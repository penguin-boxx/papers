...
In many cases, such an entity can be abstractly called an execution context of a program, and effects arise naturally here as an interactions of a computation with that context.

An execution context can be distinguished by at least one of the following properties.
Firstly, it can be responsible for bookkeeping using some kind of storage, such that one act of interaction with it may affect others.
