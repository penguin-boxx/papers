...
\begin{figure}
    \[
        \begin{array}{llll}
            ...
            \\
            \text{(perform)} &handler_m~E[perform \ap op_j\ap (K \ap m \ap \overline{t_i})\ap\overline{\tau}\ap\overline{v}] &\longrightarrow &t_j \ap \overline{\tau}\ap \overline{v}\ap k
            \\
            &&&\text{where } t_j : \forall \overline{\alpha}\ldotp \tau'\to (\sigma \to \sigma')\to\sigma',
            \\
            &&& k = \lambda x : [\overline{\alpha\to\tau}]\ap\sigma \ldotp handler_m~E[x]
            \\
            & \infer[step]{E[t]\longrightarrow E[t']}{t\longrightarrow t'} &&
        \end{array}
    \]
...
\begin{figure}
    ...
    \end{align*}
%    \begin{equation}
%        \inference[Handle]{kek}{lol}
%    \end{equation}
%    \begin{align*}
    \[
        %! suppress = EscapeAmpersand
        \infer[Handle]{
            \Gamma \vdash handle ~ x : T\ap\overline{\tau}~ with ~ \{op_i = t_i\} ~in~u : \eta
        }{
            \begin{gathered}
            ...
            &
            \begin{array}{ll}
                \overline{\beta}\not\subset ftv(\eta) &K : \forall\overline{\alpha}\ldotp(\overline{\forall\overline{\beta}\ldotp\overline{\sigma}_i\to(\sigma'_i\to\eta)\to\eta})\to T\ap\overline{\alpha} \\
                \theta = [\overline{\alpha\to\tau}] &\Gamma\vdash\theta\ap t_i : \forall \overline{\beta}\ldotp \overline{\theta\ap\sigma_i}\to(\theta\ap\sigma_i'\to\eta)\to\eta
            \end{array}
        }
    \]
%    \end{align*}
