...
To achieve an efficient implementation of subtyping, we restrict it to be shallow.
Namely, one functional type subtypes another only if one effect row subtypes another, while arguments and return types should be the same:
\[
