...
\begin{minted}{swift}
    func mapFirst(p: Pair<a, b>): ((a) -> c)'la&lb -> Pair<c, b>
...
\begin{minted}{swift}
    func compose<a <: Any', b <: Any', c <: Any'>(f: (b)' -> c, g: (a)' -> b): (a)' -> c
\end{minted}
...
\begin{minted}{swift}
    func compose<a, b, c>(f: (b) -> c, g: (a) -> b): (a)'f+g -> c
\end{minted}
...
\begin{minted}{swift}
    func makeRepository(files: Map<String, file: File>): Repository'file
\end{minted}
...
\subsection{Conventional row-polymorphic effect systems} \label{subsec:overview-rows}

Row-based effect systems are
...
\subsection{Misc} \label{subsec:overview-misc}
