...
\lstdefinelanguage{colang}{
    keywords=[1]{let, effect, perform, data, context, fun, where, if, else, throw, try, catch, local, free, op},
    sensitive=true,
    comment=[l]{//},
    morecomment=[s]{/*}{*/},
    morestring=[b]",
...
For the parameter \lstinline[language=colang]|a| we use the polymorphic bound \lstinline[language=colang]|la| and include it into the resulting lifetime, since resulting lazy list captures initial list.
