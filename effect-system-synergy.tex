...
% todo extract core calculus to the separate section
...
Actually, the decision is about choosing the default, since one behaviour can be changed to another by $\eta$-expansion. % todo explain better, examples
