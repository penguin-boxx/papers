...
\begin{figure}
    \[
        \begin{array}{lrl}
            ...
            & & \vor \graybox{\alpha <: \tau, \Gamma} \vor \graybox{l <: \Delta, \Gamma} \\
    ...
    \begin{gather*}
        ...
        \infer[Handle]{
            ...
            \begin{array}{ccc}
                ...
                op_i : \forall\overline{\beta_i}\ldotp \overline{\sigma_i}\to\sigma'_i \in sig
                \\
                local, \star \not\in lt_\emptyset^+(\eta)\cup\overline{lt_{\overline{\beta <: Any\ap free}, \Gamma}^+(\theta\ap\sigma_i)}
                &
                \theta = [\overline{\alpha\to\tau}]
                &
                \Gamma\vdash\theta\ap t_i : \forall \overline{(\beta <: Any\ap free)}\ldotp \ctx{} (\overline{\theta\ap\sigma_i}, \theta\ap\sigma_i'\to\eta)\to\eta
            \end{array}
        }\\
        \infer[Cap]{
