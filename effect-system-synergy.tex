...
If is convenient to introduce some form of subtyping on effect rows, since a function


since a function with less context requirements can definitely be passed to a function providing more capabilities.
