...
TODO % todo something about capabilities
...
%    \[
%        \begin{array}{lrll}
%            \text{Values} &v &\Coloneqq x \vor \Lambda \overline{\alpha} \ldotp v \vor \lambda \overline{x : \tau}~\overline{y : \sigma}\ldotp t \vor K\ap\overline{\tau}\ap\overline{v}
%            \\
%            \text{Terms} &t, u &\Coloneqq \\
%            &&\vor v \\
%            &&\vor t\ap\overline{\tau} \\
