...
\selectlanguage{english}
    ...
    \begin{enumerate}
        \item \emph{Axiomatized lemmas.}
            ...
            auxiliary lemmas is axiomatized.
            These are concentrated in de~Bruijn plumbing and $\forall$-subtyping
            inversion, both of which are standard but voluminous to discharge by hand.
    ...
    type safety, which provides a concrete foundation for designing future
    capability-based effect systems with simple user-facing annotations.
    ...
    First, the remaining axiomatized lemmas (mostly de~Bruijn plumbing and
    $\forall$-subtyping inversion) need to be discharged.
